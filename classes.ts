...
class AttributeCollection extends BaseCollection<Attribute> {
  makeHTML(): string {
    let html = "";
...
class SkillCollection extends BaseCollection<Skill> {
  makeHTML(): string {
    let html = "";
...
class Vehicle extends BaseCollection<VehicleStat> {
...
class VehicleCollection extends BaseCollection<Vehicle> {
  ...
  getVehicle(name: string): Vehicle | undefined {
